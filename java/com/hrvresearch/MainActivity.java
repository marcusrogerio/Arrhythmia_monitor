package com.hrvresearch;
        ...
        import com.hrvresearch.LPGraphicalView;
        import com.hrvresearch.Mode;
        import com.hrvresearch.SelfClearingMessage;
        import com.hrvresearch.ZephyrManager;
...
public class MainActivity extends Activity implements View.OnClickListener, View.OnTouchListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_NOSENSOR); // prevents auto rotation
...
//        context = getApplicationContext();//
    ...
    public void receivenewRR(int rr) {
        ...
        if (myMode==Mode.SINGLENUMBER ) {
            if (rr == lastnumber)
            {
                // David wanted screen to flash if this was the case.
